...
@section('badge')
          ...
          <span><img src="{{ asset('assets/images/logo/u_angle-right.png')}}" alt="" /></span>
          <span class="middle-badge">Cập nhật tài khoản</span>
@endsection
            ...
            <div class="card-body">
              ...
              <div class="row mt-3">
                <div class="col-6 mt-3">
                  ...
                  <input type="text" name="full_name" id="full_name" value="{{ old('full_name', $user->full_name) }}" required class="my-form-control mt-3" >
                </div>

                <div class="col-6 mt-3">
                    Tên đăng nhập <span class="text-danger">*</span><br />
                    <input type="text" class="my-form-control mt-3" type="text" name="username" id="username" value="{{ old('username', $user->username) }}" required>
                </div>

                <div class="col-6 mt-3">
                  Số điện thoại <span class="text-danger">*</span><br />
                  <input type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $user->phone_number) }}" class="my-form-control mt-3" required/>
                </div>
                <div class="col-6 mt-3">
                ...
                <div class="col-6 mt-3">
                    ...
                    <input class="my-form-control mt-3" name="email" id="email" value="{{ old('email', $user->email) }}"  required/>
                  </div>
            ...
            @endforeach
                  ...
                  <div class="col-6 mt-3">
                    ...
                    <select class="my-form-control mt-3"id="active" name="active" required>
                        <option value="0" {{ $user->active == 0 ? 'selected' : '' }}>Ngưng hoạt động</option>
